...
| Applicable frameworks | {EU AI Act, GPAI CoP, GDPR, NIST AI RMF, Colorado AI Act, NYC LL144, HIPAA} |
| Audit date | {date} |
...
|---|---|---|---|---|---|
| 1.1 | AI governance policy documented | NIST GOV-1 | Medium | | |
| 1.2 | Accountable individuals assigned for AI risk | NIST GOV-1.1, Colorado | High | | |
| 1.3 | Model card or technical documentation exists | EU Art. 11, Colorado | High | | |
| 1.4 | Intended purpose and limitations documented | EU Art. 13, NIST MAP-1.1 | High | | |
| 1.5 | Change log for model/prompt updates maintained | EU Art. 11, NIST GOV-5 | Medium | | |
...
| 2.2 | Data Protection Impact Assessment conducted | GDPR Art. 35 | High | | |
...
| # | Item | Regulation | Priority | Status | Remediation |
|---|---|---|---|---|---|
| 3.1 | Prompt injection defences implemented | EU Art. 15, NIST MEA-2.7 | High | | |
| 3.2 | Output filtering / guardrails in place | NIST MAN-1.2 | High | | |
| 3.3 | Data loss prevention for sensitive output | NIST MAN-1.2, HIPAA | High | | |
...
| # | Item | Regulation | Priority | Status | Remediation |
|---|---|---|---|---|---|
| 4.1 | Bias and fairness testing across demographic groups | NIST MEA-2.1, Colorado, NYC LL144 | High | | |
| 4.2 | Adversarial / red team testing conducted | NIST MEA-2.5, GPAI CoP | High | | |
| 4.3 | Evaluation pipeline for accuracy and quality | NIST MEA-1.1 | Medium | | |
...
| # | Item | Regulation | Priority | Status | Remediation |
|---|---|---|---|---|---|
| 5.1 | Users informed they are interacting with AI | EU Art. 50, Colorado | Critical | | |
...
| 5.5 | Capabilities and limitations communicated to users | EU Art. 13, Colorado | Medium | | |

## 6. Monitoring and continuous compliance

| # | Item | Regulation | Priority | Status | Remediation |
|---|---|---|---|---|---|
| 6.1 | Arize tracing captures all LLM calls | EU Art. 12, NIST MAN-2.1 | High | | |
| 6.2 | Error and exception tracking on spans | NIST MAN-2.1 | Medium | | |
| 6.3 | Drift detection and alerting configured | NIST MEA-3.1 | Medium | | |
| 6.4 | Trace retention meets regulatory requirements | EU Art. 12, HIPAA | High | | |
| 6.5 | Periodic re-audit schedule defined | NIST GOV-5, Colorado | Medium | | |

## 7. Vendor management

| # | Item | Regulation | Priority | Status | Remediation |
|---|---|---|---|---|---|
| 7.1 | All third-party AI APIs documented | NIST MAP-3.1, GOV-6 | Medium | | |
| 7.2 | Model versions pinned (not using "latest") | NIST MAP-3.2 | Medium | | |
| 7.3 | Data Processing Agreements with all processors | GDPR Art. 28 | Critical | | |
| 7.4 | Vendor does not train on your data (confirmed in writing) | HIPAA, GDPR | High | | |
