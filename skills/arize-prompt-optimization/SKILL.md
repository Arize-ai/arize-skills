...
Use the template at [references/meta-prompt-template.md](references/meta-prompt-template.md) to generate an improved version of the prompt. Fill in the three placeholders and send it to your LLM (GPT-4o, Claude, etc.).
