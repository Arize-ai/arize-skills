...
Fill in the three placeholders in [references/optimization-meta-prompt.md](references/optimization-meta-prompt.md) and send it to your LLM (GPT-4o, Claude, etc.) to generate an improved version of the prompt.
