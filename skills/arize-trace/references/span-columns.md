...
Consult this when you need to know which column holds a specific piece of span data (prompts, cost, tool calls, retrieved documents, etc.) for `--filter` expressions or output inspection.
