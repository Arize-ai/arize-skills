...
| [arize-dashboard](skills/arize-dashboard/SKILL.md) | Create and edit AX dashboards via programmatic GraphQL: list by project, templates, widgets, rename/status; resolve by project and dashboard name. |
